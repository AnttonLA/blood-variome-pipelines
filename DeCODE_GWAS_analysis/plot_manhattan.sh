...
#
# Usage: plot_manhattan.sh  <input_file> <output_file>
#
# Example command:
...
# Global path of this script (credit: https://stackoverflow.com/questions/24112727/relative-paths-based-on-file-location-instead-of-current-working-directory)
parent_path=$( cd "$(dirname "${BASH_SOURCE[0]}")" ; pwd -P )
number_of_aliases=$( awk -f $parent_path/utils/count_aliases.awk $1 )
color_list=$( python $parent_path/utils/pick_colors.py "$number_of_aliases")
...
#"#E95D1F,#3C8D2E,#9C00E9,#00E91B,#E900E1,#00E0E9,#E9C800"

 manhattan_maker --in-file $1 --col-name "ID" --col-chr "chromosome" --col-pos "position" --col-pvalue "pval"\
 --significant-threshold 11 --point-size 4 --significant-point-size 4 --abline 7.301029995664,11\
 --odd-chromosome-color "#ececec" --even-chromosome-color "#a9a9a9" --significant-color "#808080"\
 --use-groups --col-groups "alias" --group-colors "$color_list"\
 --chromosome-box-color "#ffffff" --axis-text-size 13 --chr-text-size 13 --label-text-size 28 --graph-height 6\
 --graph-width 15 -o $2
